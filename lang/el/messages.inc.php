...
$langRevealPass = "Εμφάνιση κωδικού";
$langHeaderLinks = "Σύνδεσμοι επικεφαλίδας";
$langFooterLinks = "Σύνδεσμοι υποσέλιδου";
$langAdd = "Προσθήκη";
...
$langNumGroupsInfo       = 'Μέγιστο 26 ομάδες (Α–Ω)';
$langQuestionsPerGroup   = 'Ερωτήσεις ανά Ομάδα';
$langGroupLabel          = 'ΟΜΑΔΑ';
$langExamGroups          = 'Εξεταστικές Ομάδες';
$langGenerateExamZIP     = 'Δημιουργία ZIP με PDF';
$langExamParameters      = 'Παράμετροι Εξέτασης';
$langSelectQuestions     = 'Επιλογή Ερωτήσεων';
$langExamGroupsInfo      = 'Κάθε ομάδα παίρνει τυχαίες ερωτήσεις. Αν δεν υπάρχουν αρκετές για ξεχωριστές ομάδες, οι ερωτήσεις μπορεί να επαναλαμβάνονται αλλά σε διαφορετική σειρά.';
$langNotEnoughQuestions  = 'Δεν υπάρχουν αρκετές επιλεγμένες ερωτήσεις. Χρειάζονται τουλάχιστον %d.';
$langNotEnoughQuestionsJS = 'Επέλεξε τουλάχιστον';
$langQuestionsSelected   = 'ερωτήσεις επιλεγμένες';
$langNeedAtLeast         = 'χρειάζονται τουλάχιστον';
$langSelectAtLeastOne    = 'Επέλεξε τουλάχιστον μία ερώτηση.';
$langJSDeselectAll       = 'Καμία';
$langPoints              = 'μον.';
$langAllCategories       = 'Όλες οι Κατηγορίες';
$langNoQuestionsFound    = 'Δεν βρέθηκαν ερωτήσεις με αυτά τα φίλτρα.';
...
$langIPUnlock = "Πρόσβαση από συγκεκριμένη διεύθυνση δικτύου";
$langIPUnlockLegend = "σε μορφή IP(s) ή CIDR(s)";
...
$langForceCompletedProgress = "Αυτόματη συμπλήρωση προόδου";
$langForceCompletedProgressInfo = "Θέτει την πρόοδο των ενοτήτων στο 100% όταν η κατάστασή τους είναι Ολοκληρωμένη.";
...
$langExport = "Εξαγωγή";
$langExport2004 = "Λήψη σε SCORM 2004";
$langExport12 = "Λήψη σε SCORM 1.2";
$langExportIMSCP = "Λήψη σε IMS CP 1.1.4";
...
$langLogModules = "Εργαλεία $langsOfCourse";
$langAllActions = "Όλες οι ενέργειες";
$langUnknownAction = "Άγνωστη ενέργεια";
$langUnknownModule = "Άγνωστο εργαλείο";
$langAllModules = "Όλα τα εργαλεία";
...
$langUserThemeCustomization = 'Προσαρμογή Θέματος Χρήστη';
$langEnableUserThemeCustomization = 'Ενεργοποίηση προσαρμογής θέματος χρήστη';
$langEnableUserThemeCustomizationHelp = 'Επιτρέψτε στους χρήστες να επιλέγουν και να προσαρμόζουν τις δικές τους προτιμήσεις θέματος. Οι χρήστες μπορούν να επιλέξουν από τα διαθέσιμα θέματα και να αποθηκεύσουν την επιλογή τους σε cookie.';
$langUserThemeCustomizationDisabled = 'Η προσαρμογή θέματος χρήστη είναι απενεργοποιημένη από τον διαχειριστή της πλατφόρμας.';
$langSelectThemesForUsers = 'Επιλογή Θεμάτων για Χρήστες';
$langSelectThemesForUsersHelp = 'Επιλέξτε ποια θέματα θα μπορούν να επιλέξουν οι χρήστες. Οι χρήστες θα βλέπουν μόνο τα θέματα που επιλέγετε εδώ.';
$langNoThemesAvailable = 'Δεν υπάρχουν διαθέσιμα θέματα για επιλογή. Παρακαλώ επικοινωνήστε με τον διαχειριστή της πλατφόρμας.';
$langLayout = 'Layout';
...
$langIdleLogoutTime = "Αυτόματη Αποσύνδεση σε (σε λεπτά)";
$langIdleWarningTitle = "Προειδοποίηση Αδράνειας";
$langIdleExpireSoon = "Η συνεδρία σας πρόκειται να λήξει σύντομα λόγω αδράνειας.";
$langIdleStayLoggedIn = "Θέλετε να παραμείνετε συνδεδεμένοι;";
$langIdleExtendSession = "Παράταση Συνεδρίας";
