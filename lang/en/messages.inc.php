...
$langCreateExamGroups    = 'Create Exam Groups PDF';
$langExamTitle           = 'Exam Title';
$langExamDate            = 'Date';
$langExamDuration        = 'Duration (minutes)';
$langNumGroups           = 'Number of Groups';
$langNumGroupsInfo       = 'Maximum 26 groups (A–Z)';
$langQuestionsPerGroup   = 'Questions per Group';
$langGroupLabel          = 'GROUP';
$langExamGroups          = 'Exam Groups';
$langGenerateExamZIP     = 'Generate ZIP with PDFs';
$langExamParameters      = 'Exam Parameters';
$langSelectQuestions     = 'Select Questions';
$langExamGroupsInfo      = 'Each group gets random questions. If there are not enough for separate groups, questions may repeat but in different order.';
$langNotEnoughQuestions  = 'Not enough questions selected. At least %d required.';
$langNotEnoughQuestionsJS = 'Select at least';
$langQuestionsSelected   = 'questions selected';
$langNeedAtLeast         = 'need at least';
$langSelectAtLeastOne    = 'Please select at least one question.';
$langJSDeselectAll       = 'None';
$langPoints              = 'pts';
$langAllCategories       = 'All Categories';
$langNoQuestionsFound    = 'No questions found with these filters.';
